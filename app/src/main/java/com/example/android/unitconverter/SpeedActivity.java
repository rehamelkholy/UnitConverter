...
public class SpeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        unitConverter.setText(getResources().getString(R.string.speed) + " " + getResources().getString(R.string.converter));
        unitConverter.setBackgroundColor(getResources().getColor(R.color.speed));
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double finalNumber = converter.speedConvert(number, fromUnit, toUnit);
    ...
    public void setSpinnerItems(){
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.speeed_units, android.R.layout.simple_spinner_item);
