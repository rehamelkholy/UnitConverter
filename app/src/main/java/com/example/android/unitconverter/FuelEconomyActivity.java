...
public class FuelEconomyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        unitConverter.setText(getResources().getString(R.string.fuel_economy) + " " + getResources().getString(R.string.converter));
        unitConverter.setBackgroundColor(getResources().getColor(R.color.fuel_economy));
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double finalNumber = converter.fuelEconomyConvert(number, fromUnit, toUnit);
    ...
    public void setSpinnerItems(){
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.fuel_economy_units, android.R.layout.simple_spinner_item);
