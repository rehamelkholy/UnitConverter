...
public class PlaneAngleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        unitConverter.setText(getResources().getString(R.string.plane_angle) + " " + getResources().getString(R.string.converter));
        unitConverter.setBackgroundColor(getResources().getColor(R.color.plane_angle));
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double finalNumber = converter.planeAngleConvert(number, fromUnit, toUnit);
    ...
    public void setSpinnerItems(){
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.plane_angle_units, android.R.layout.simple_spinner_item);
