...
public class DataTransferRateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        unitConverter.setText(getResources().getString(R.string.data_transfer_rate) + " " + getResources().getString(R.string.converter));
        unitConverter.setBackgroundColor(getResources().getColor(R.color.data_transfer_rate));
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double finalNumber = converter.dataTransferRateConvert(number, fromUnit, toUnit);
    ...
    public void setSpinnerItems(){
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.data_transfer_rate_units, android.R.layout.simple_spinner_item);
