...
public class VolumeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        unitConverter.setText(getResources().getString(R.string.volume) + " " + getResources().getString(R.string.converter));
        unitConverter.setBackgroundColor(getResources().getColor(R.color.volume));
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double finalNumber = converter.volumeConvert(number, fromUnit, toUnit);
